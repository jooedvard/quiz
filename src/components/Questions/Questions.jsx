...
const Questions = ({ questions, reset }) => {
  ...
  const onFinish = () => {
    ...
    questions.forEach((question, index) => {
      results.answersList[index] = [
        question,
        question.correctAnswer === chosenAnswers[index],
      ];
    });
  ...
  return (
    <div className="flex flex-col justify-between w-full">
      {renderResult ? (
        <FinishModal result={result} setRenderResult={setRenderResult}></FinishModal>
      ) : (
        <>
          ...
          <div className="flex justify-between mt-4 flex-col sm:flex-row">
            ...
            <div>
              ...
              >
                ...
                <a href="https://github.com/jooedvard/quiz" target={"_blank"}>
                  Open on Github
                </a>
              </button>
            </div>
